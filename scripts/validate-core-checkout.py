...
EXPECTED_WORKFLOWS = {
    ...
    # decisions/0022 Amendment 3, second use). Declares no reusable
...
EXPECTED_ACTION_CHECKOUTS = {
    ...
    "web-crs.yml": 2,
    "web-plan.yml": 1,
    "web-generation-44-parity.yml": 1,
}
...
EXPECTED_CORE_CI_PATH_EXPORTS = {
    ...
    "web-crs.yml": 1,
    "web-plan.yml": 0,
    "web-generation-44-parity.yml": 0,
}

EXPECTED_PERMISSIONS = {
    workflow: (
        ("actions: read", "contents: read", "pull-requests: read")
        if workflow == "web-generation-44-parity.yml"
